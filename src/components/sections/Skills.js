          ...
          <div className="col col-d-6 col-t-6 col-m-12 border-line-v">
            <div className="skills-list">
              <div className="skill-title border-line-h">
                ...
                <div className="name">Langues</div>
              </div>
              <ul>
                <li>
                ...
                <li className="border-line-h">
                  <div className="name">Japonais</div>
                  <div className="progress">
                    <div className="percentage" style={{ width: '70%' }} />
                  </div>
                </li>
          ...
          <div className="col col-d-6 col-t-6 col-m-12 border-line-v">
            <div className="skills-list list">
              <div className="skill-title border-line-h">
                ...
                <div className="name">Compétences personnelles</div>
              </div>
              <ul>
                <li>
                  <div className="name">Capacité d'adaptation</div>
                </li>
                <li>
                  <div className="name">Autonomie</div>
                </li>
                <li>
                  <div className="name">Capacité d'apprentissage</div>
                </li>
              </ul>
            </div>
          </div>
