        ...
        <div className="row">
          ...
          <div className="col col-d-6 col-t-6 col-m-12 border-line-v">
            ...
            <div className="resume-items">
              <div className="resume-item border-line-h active">
                <div className="date">Juin 2022 - Septembre 2022</div>
                <div className="name">
                  Formation de développeur d'applications mobiles en react
                  native
                </div>
                <div className="company">La Manu</div>
              </div>
              <div className="resume-item border-line-h">
                <div className="date">Juin 2021 - Décembre 2021</div>
                <div className="name">Formation Développeur Web/Web Mobile</div>
                <div className="company">La Manu</div>
                <p>Formation de développeur html/css php</p>
              </div>
            </div>
          </div>
          {/* education */}
          <div className="col col-d-6 col-t-6 col-m-12 border-line-v">
            <div className="resume-title border-line-h">
              ...
              <div className="name">Parcours Scolaire</div>
            </div>
            <div className="resume-items">
              <div className="resume-item border-line-h">
                <div className="date">2018-2021</div>
                <div className="name">Licence LLCER de Japonais</div>
                <div className="company">Université de Paris</div>
                <p>Niveau Licence</p>
              </div>
            </div>
          </div>
