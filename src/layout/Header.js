...
const headerMenus = [
  { title: 'À propos', link: 'about', icon: 'icon fa fa-user-o' },
  { title: 'Parcours', link: 'resume', icon: 'icon fa fa-list-alt' },
  { title: 'Portfolio', link: 'works', icon: 'icon fa fa-object-ungroup' },
